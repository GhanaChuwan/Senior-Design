...
const validationSchema = Yup.object({
    firstName:Yup.string().trim().min(3, 'Invalid name!').required('First name is required!'),
    lastName:Yup.string().trim().min(3, 'Invalid name!').required('Last name is required!'),
    ...
    return(
        <SafeAreaView style={{backgroundColor:'#fdf6ec',  flex:1}}>
            <ScrollView contentContainerStyle={{paddingTop: 70,paddingHorizontal:20 }}>
                <TouchableOpacity onPress={() => navigation.navigate("SignIn")} style={{marginBottom:10}}>
                        ...
                        {({
                            ...
                            return (
                                <>
                                    ...
                                    />
                                    <CustomButton
                                        text="Have an account? Sign-In" type="LINKBUTTON" onPress={() => navigation.navigate("SignIn")}
                                    />
                                </>
                            )
                        }}
